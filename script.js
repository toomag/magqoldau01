...
(() => {
  ...
  const dict = {
    ru: {
      ...
      contactsAddressValue: "Астана, Баян сулу 42",
      ...
      hoursNote:
        "Если напишете вне графика — мы ответим в ближайшее рабочее время.",
    ...
    en: {
      ...
      contactsDesc:
        "Reach out using a convenient channel — we respond during business hours.",
      contactsEmailLabel: "Email",
      contactsPhoneLabel: "Phone",
      contactsAddressLabel: "Address",
      contactsAddressValue: "Astana, Bayan sulu 42",
      ...
      hoursClosed: "Closed",
      hoursNote:
        "If you message outside business hours, we will reply on the next working day.",
    },
  };
